...
Em um estudo sobre as alturas dos moradores de uma cidade verificou-se que o conjunto de dados segue uma distribuição normal, com média 1,70 e desvio padrão de 0,1. Com esta informação obtenha o seguinte conjunto de probabilidades: 
...
c) Amostragem por conglomerado: são criados grupos heterogêneos, como por exemplo divisão da pop. em grupos territoriais diversos entre si. É comum fazer a amostragem estratificada e aleatória depois da amostragem por conglomerado. 


Teorema de limite central

Esse teorema afirma que, com o aumento do tamanho da amostra, a distribuição das médias amostrais se aproxima de uma distribuição normal com média igual a média da população e desvio padrão igual ao desvio padrão da variável original divido pela raiz quadrada do tamanho da amostra. Este fato é assegurado para n maior ou igual a 30. 
...
Suponha que os pesos de sacos de arroz de uma indústria alimentícia distribuem aproximadamente como uma normal de desvio padrão populacional igual a 150g. Selecionada uma amostra aleatória de 20 sacos de um lote específico, obteve-se um peso médio de 5.050g. Construa um intervalo de confiança para a média populacional assumindo um nível de significância de 5% 
...
O nível de confiança representa a probabilidade de acerto da estamativa. De forma forma complementar o nível de significância  (α)  expressa a probabilidade de erro da estimativa 

O nível de confiança  (1 - α) representa o grau de vonfiabilidade do resultado da estimativa estar dentro de determinado intervalo. Quando fixamos em uma pesquisa um nível de confiança de 95%, por exemplo, estamos asssumindo que existe uma probabilidade de 95% dos resultados da pesquisa representarem bem a realidade, ou seja, estarem corretos. 
...
Suponha que os pesos de sacos de arroz de uma indústria alimentícia se distribuem aproximadamente como uma normal de desvio padrão populacional igual a 150g. Selecionada uma amostra aleatória de 20 sacos de um lote específico, obteve-se um peso médio de 5.050g. Construa um intervalo de confiança para a média populacional assumindo um nível de significância de 5% 
...
Estamos estudando o rendimento mensal dos chefes de domícilios no Brasil. Nosso supervisor determinou que o erro máximo em relação a média seja de R$ 100. Sabemos que o desvio padrão populacional deste grupo de trabalhadores é de 3.323,39 reais. Para um nível de confiança de 95% qual deve ser o tamanho da amostra do nosso estudo? 
